...
mod tests {
    ...
    fn test_either_pattern() {
        ...
        assert!(matches!(p[0], Pattern::Alternate(..)));
    }
    #[test]
    fn test_combined_patterns() {
        ...
        assert!(matches!(p[6], Pattern::Alternate(..)));
    }
    ...
    fn test_nested_groups_and_either() {
        ...
        if let Pattern::Alternate(_, ref variants) = p[3] {
    ...
    fn test_nested_either_with_groups() {
        ...
        if let Pattern::Alternate(_, ref variants) = p[0] {
            // First variant: "a"
            ...
            if let [Pattern::Alternate(_, ref nested_either)] = &variants[2][..] {
